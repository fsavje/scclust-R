...
test_that("`check_scclust` returns correct output", {
  expect_equal(check_scclust(cl1, 2), TRUE)
  expect_equal(check_scclust(cl1, 3), TRUE)
  expect_equal(check_scclust(cl1, 4), FALSE)
  expect_equal(check_scclust(cl2, 2), TRUE)
  expect_equal(check_scclust(cl2, 3), TRUE)
  expect_equal(check_scclust(cl2, 4), FALSE)
  expect_equal(check_scclust(cl3, 2), TRUE)
  expect_equal(check_scclust(cl3, 3), TRUE)
  expect_equal(check_scclust(cl3, 4), FALSE)
  expect_equal(check_scclust(cl4, 2), TRUE)
  expect_equal(check_scclust(cl4, 3), TRUE)
  expect_equal(check_scclust(cl4, 4), FALSE)

  expect_equal(check_scclust(cl1, NULL, dp_types, c("x" = 1, "y" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl1, 3, dp_types, c("x" = 1, "y" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl1, NULL, dp_types, c("x" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl1, 3, dp_types, c("y" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl1, 4, dp_types, c("x" = 1, "y" = 1, "z" = 1)), FALSE)
  expect_equal(check_scclust(cl1, NULL, dp_types, c("x" = 3, "y" = 1, "z" = 1)), FALSE)

  expect_equal(check_scclust(cl2, NULL, dp_types, c("x" = 1, "y" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl2, 3, dp_types, c("x" = 1, "y" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl2, NULL, dp_types, c("x" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl2, 3, dp_types, c("y" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl2, 4, dp_types, c("x" = 1, "y" = 1, "z" = 1)), FALSE)
  expect_equal(check_scclust(cl2, NULL, dp_types, c("x" = 3, "y" = 1, "z" = 1)), FALSE)

  expect_equal(check_scclust(cl3, NULL, dp_types, c("x" = 1, "y" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl3, 3, dp_types, c("x" = 1, "y" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl3, NULL, dp_types, c("x" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl3, 3, dp_types, c("y" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl3, 4, dp_types, c("x" = 1, "y" = 1, "z" = 1)), FALSE)
  expect_equal(check_scclust(cl3, NULL, dp_types, c("x" = 3, "y" = 1, "z" = 1)), FALSE)

  expect_equal(check_scclust(cl4, NULL, dp_types, c("x" = 1, "y" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl4, 3, dp_types, c("x" = 1, "y" = 1, "z" = 1)), TRUE)
  expect_equal(check_scclust(cl4, NULL, dp_types, c("x" = 1, "z" = 1)), TRUE)
